    ...
    return (
        ...
        >
            ...
            <p className="text-base leading-relaxed w-full mb-6">
                Kanker kulit ganas adalah jenis kanker kulit yang bersifat ganas
                atau malignant, artinya sel-sel abnormal pada kulit tumbuh
                secara tidak terkendali dan dapat menyebar ke jaringan lain di
                tubuh (metastasis). Salah satu bentuk kanker kulit ganas yang
                paling berbahaya adalah melanoma, yang berasal dari sel
                penghasil pigmen kulit (melanosit). Selain melanoma, terdapat
                juga jenis kanker kulit ganas lainnya seperti karsinoma sel
                basal (basal cell carcinoma) dan karsinoma sel skuamosa
                (squamous cell carcinoma). Kanker kulit ganas umumnya disebabkan
                oleh paparan sinar ultraviolet (UV) yang berlebihan dari
                matahari atau alat tanning buatan, terutama tanpa perlindungan
                yang memadai. Gejalanya bisa berupa perubahan bentuk, warna,
                atau ukuran pada tahi lalat atau bercak kulit, luka yang tidak
                sembuh-sembuh, atau benjolan yang terasa gatal atau berdarah.
                Deteksi dini sangat penting karena kanker kulit ganas yang
                ditemukan lebih awal memiliki peluang kesembuhan yang lebih
                tinggi melalui tindakan medis seperti operasi, terapi radiasi,
                atau imunoterapi. Edukasi tentang perlindungan kulit dan
                pemeriksaan rutin sangat penting untuk mencegah dan menangani
                kanker kulit ganas secara efektif.
            </p>

            <p className="text-base leading-relaxed w-full mb-10">
                Untuk mencegah kanker kulit ganas, penting bagi setiap individu
                untuk melindungi kulit dari paparan sinar ultraviolet (UV)
                secara berlebihan. Langkah pencegahan utama meliputi penggunaan
                tabir surya (sunscreen) dengan SPF minimal 30 setiap hari,
                mengenakan pakaian pelindung seperti topi dan baju lengan
                panjang saat berada di luar ruangan, serta menghindari sinar
                matahari langsung terutama pada pukul 10 pagi hingga 4 sore
                ketika intensitas UV berada di puncaknya. Selain itu, hindari
                penggunaan alat tanning buatan karena juga memancarkan sinar UV
                berbahaya. Pemeriksaan kulit secara berkala—baik secara mandiri
                maupun oleh tenaga medis—sangat dianjurkan untuk mendeteksi
                perubahan mencurigakan pada kulit sedini mungkin. Edukasi dan
                kesadaran tentang bahaya sinar UV serta pentingnya perlindungan
                kulit harus dimulai sejak usia dini guna menekan angka kejadian
                kanker kulit ganas di masyarakat.
            </p>
