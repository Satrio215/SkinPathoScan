...
const Artikel = () => {
  ...
  const fetchArticles = async (page = 1) => {
    try {
      setLoading(true);
      const response = await axios.get(`https://qwerty.satrio.io/api/articles?page=${page}`);
  ...
  const ErrorState = () => (
    <div className="flex flex-col items-center justify-center p-12 bg-red-50 rounded-lg border border-red-200">
      ...
      <h3 className="text-lg font-medium text-red-800 mb-2">Gagal memuat artikel</h3>
  ...
  return (
    <div className="py-12 px-4">
      <div className="max-w-5xl mx-auto mb-10">
        <h1 className="text-4xl font-bold text-white">Artikel SkinPathoScan</h1>
      </div>
                ...
                <div className="p-6 flex flex-col justify-between w-full">
                  <div>
                    ...
                    <p className="text-gray-600 mb-4 line-clamp-4 break-all">
                      {artikel.bio ? artikel.bio.slice(0, 200) + "..." : "Tidak ada deskripsi"}
                    </p>
                  </div>
